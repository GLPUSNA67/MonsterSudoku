...
# from MS_Solutions_1 import *  # load_solution_1
# Path is C:\Users\Owner\Documents\GitHub\GLPCCWeb\chemistryapp\static\matrix\assets\css\MS_Solutions.pyC:\PythonProjects\MonsterSudoku\MonsterSudoku.py
# import sets
        ...
        try:
            for item in duple_candidate_list:
                ...
                # If the current cell is not the same as the original cell, process it
                    ...
                    print("901 pairs are ", i_row, i_col, i_sq, i_pair,
...
def reset_cell_values(current_btn, aref):
    # global currentNumber
    # print("1412 Entered reset_cell_values ", currentNumber, current_btn,
    #       arrRef117['done'], arrRef117['nums'])
    # , type(
...
def update_cell(btn, aref, btn_ID, aref_ID):
    ...
    if not btn_ID == "" and bRemoveANumberFromACell == False:
        ...
        # currentNumber
        history = f"currentNumber = \'{currentNumber}\' \n update_cell( {btn_ID}, {aref_ID}, \'{btn_ID}\', \'{aref_ID}\')\n"
...
def print_problem_cells():
    print("2166 values for R5C2", arrRef65['done'], arrRef65['nums'])
    print("2167 values for R5C6", arrRef69['done'], arrRef69['nums'])
    print("2168 values for R6C7", arrRef86['done'], arrRef86['nums'])
    print("2169 values for R11C2", arrRef161['done'], arrRef161['nums'])
    print(len(not_done_arefs), not_done_arefs)
...
btn_IDTriples = Button(fn_frame, wraplength=40, justify=LEFT, text='test\n1',
                       command=text_1, width=6, height=hit)
