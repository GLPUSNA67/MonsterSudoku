...
def load_currentSolution():
    ...
    print("3006 Entered load_solution_1")
    global currentNumber
    print("3008 currentSolutin is ", currentSolution)
    # for item in currentSolution:
    #     print("2304 load item ", item)
    #     item
    currentNumber = 'A'
...
>>>>>>> f62873f9aff5ce00a4f7e60ad0d9e00f655bbb70:MonsterSudoku.py
