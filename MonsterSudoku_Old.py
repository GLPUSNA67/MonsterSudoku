...
def make_RCS_lists_for_triples(triple_candidate_list):
    ...
    for item in triple_candidate_list:
        ...
        # print("1496 row_lists is ", row_lists)
...
def test_4():
    # print("4018 aref_rows ", aref_rows)
    for aref_list in aref_rows:
        # print("4019 ", aref_list)
...
def save_currentSolution_1():
    print("2626 Entered save_currentSolution")
    global currentNumber
...
btn_reload.grid(row=4, column=2, sticky='nw')
btn_reload.config(font=entryfont)
